...
public class FisheyeFilter extends Filter {
    ...
    private static final String mFisheyeShader =
            ...
            "  float dist = sqrt((gl_FragCoord.x - center.x) * 0.125 * (gl_FragCoord.x - center.x) \n" +
            "                   * 0.125 + (gl_FragCoord.y - center.y) * 0.125 * (gl_FragCoord.y - center.y) * 0.125);\n" +
    ...
    private void updateProgramParams() {
        ...
        float sWidth = mWidth * 0.125f;
        float sHeight = mHeight * 0.125f;
        float bound2 = 0.25f * (sWidth * sWidth  + sHeight * sHeight);
