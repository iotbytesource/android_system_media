...
public class LomoishFilter extends Filter {
    ...
    private final String mLomoishShader =
            ...
            // vignette
            "  float dist = sqrt((gl_FragCoord.x * 0.125 - center.x * 0.125) * (gl_FragCoord.x * 0.125 - center.x * 0.125)\n" +
            "                  + (gl_FragCoord.y * 0.125 - center.y * 0.125) * (gl_FragCoord.y * 0.125 - center.y * 0.125)) * 8.0;\n" +
